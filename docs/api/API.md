...
- [Video Protocol Flows](#video-protocol-flows)
...
## Video Protocol Flows

Comprehensive sequence diagrams and message flows for the A2UI Video Protocol extension.

### Protocol Flow Documents

#### Epic 1: Core Video Protocol (v0.10)

- **[Recording Protocol Flow](./recording-protocol-flow.md)** - Screen/camera recording flows
  - Message types: `requestRecording`, `recordingStarted`, `recordingComplete`
  - AI features: Transcription, highlights, summarization

- **[Video Call Protocol Flow](./video-call-protocol-flow.md)** - Real-time video conferencing
  - Message types: `initiateVideoCall`, `videoCallJoined`, `videoCallEnded`
  - Features: Multi-participant, screen sharing, live transcription

- **[Video Generation Protocol Flow](./video-generation-protocol-flow.md)** - AI video generation
  - Message types: `generateVideo`, `videoGenerationProgress`, `videoGenerationComplete`
  - Modes: Template-based, prompt-based, data-driven

- **[Error Handling Flow](./error-handling-flow.md)** - Comprehensive error scenarios
  - All error codes and recovery patterns
  - Fatal, recoverable, and warning errors

#### Epic 2: AI Intelligence Protocol (v0.11)

- **[AI Intelligence Protocol Flow](./ai-intelligence-protocol-flow.md)** - AI+Database features
  - Semantic search: Natural language video search
  - AI metadata: Transcripts, summaries, topics, highlights
  - Progress tracking: Cross-device sync, scene-aware resume
  - Recommendations: Personalized video suggestions

### Quick Links

- **[Protocol Flows Index](./protocol-flows-index.md)** - Complete overview and reference
- **[Video Protocol PRD](../planning/video-protocol-prd.md)** - Product requirements
- **[Video Backlog](../planning/BACKLOG.md)** - User stories and timeline
