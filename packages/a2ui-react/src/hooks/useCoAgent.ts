...
export function useCoAgent<T = Record<string, unknown>>(
  ...
  const resolveConflict = useCallback((
    clientState: T,
    agentState: T,
    agentMessage: AgentStateUpdateMessage
  ): T => {
  ...
  const handleAgentUpdate = useCallback((message: AgentStateUpdateMessage) => {
