...
import type { ZeroDBMessage } from './zerodb-messages.js'
...
export type MessageType =
  ...
  | 'authPasswordResetVerifySuccess'
  | 'authPasswordResetComplete'
  | 'authPasswordResetCompleteSuccess'
  ...
  | 'authSessionTerminateSuccess'
  | 'authSessionError'
  | 'auth2FASetup'
  | 'auth2FASetupResponse'
  | 'auth2FAVerify'
  | 'auth2FAVerifySuccess'
  | 'auth2FADisable'
  | 'auth2FADisableSuccess'
  | 'auth2FAError'
  | 'authOAuthInitiate'
  | 'authOAuthInitiateResponse'
  | 'authOAuthCallback'
  | 'authOAuthCallbackSuccess'
  | 'authOAuthError'
  | 'authLogout'
  | 'authLogoutSuccess'
  | 'authLogoutError'
  ...
  | 'zerodbVectorSearch'
  | 'zerodbVectorSearchResult'
  | 'zerodbTableQuery'
  | 'zerodbTableQueryResult'
  | 'zerodbTableInsert'
  | 'zerodbTableUpdate'
  | 'zerodbTableDelete'
  | 'zerodbTableOperationResult'
  | 'zerodbFileList'
  | 'zerodbFileListResult'
  | 'zerodbFileUpload'
  | 'zerodbFileDownload'
  | 'zerodbFileDownloadResult'
  | 'zerodbFileDelete'
  | 'zerodbPostgresQuery'
  | 'zerodbPostgresQueryResult'
  | 'zerodbPostgresStatus'
  | 'zerodbPostgresStatusResult'
  | 'zerodbMemorySearch'
  | 'zerodbMemorySearchResult'
  | 'zerodbMemoryStore'
  | 'zerodbAnalyticsQuery'
  | 'zerodbAnalyticsQueryResult'
